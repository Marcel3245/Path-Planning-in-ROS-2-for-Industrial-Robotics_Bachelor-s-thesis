...
// ======================================================================================================== //
  ...
  target_place_pose_.pose.position.x = -0.13;
  target_place_pose_.pose.position.y = -0.3525;
  target_place_pose_.pose.position.z = 0.935;
  ...
  std::string object_name = "workpiece";
